...
export const ROUTES = [
  ...
  { name: "About Us | เกี่ยวกับเรา", path: "/about-us" },
  {
    ...
    subRoutes: [
    {
      name:"มุมคอร์สอาหารเฉพาะบุคคล",
      routes: [
        {
          name: "ผู้ป่วยมะเร็ง",
          path: `/categories/มุมผลิตภัณฑ์ดูแลผู้ป่วยมะเร็ง`,
        },
        {
          name: "ผู้ป่วยไต",
          path: `/categories/มุมผลิตภัณฑ์ดูแลผู้ป่วยโรคไต`,
        },
        {
          name: "ผู้ป่วยเบาหวาน ความดันโลหิตสูง ไขมันในเลือดสูง",
          path: `/categories/มุมผลิตภัณฑ์ดูแลผู้ป่วยเบาหวาน ความดัน`,
        },
        {
          name: "ผู้ที่ต้องการลดน้ำหนัก",
          path: `/categories/ผู้ที่ต้องการลดน้ำหนัก`,
        },
        {
          name: "ผู้ที่ต้องการลีน/เสริมสร้างกล้ามเนื้อ",
          path: `/categories/เสริมสร้างกล้ามเนื้อ`,
        },
        {
          name: "ผู้ที่ต้องการลีน/เสริมสร้างกล้ามเนื้อ",
          path: `/categories/เสริมสร้างกล้ามเนื้อ`,
        ...
        {
          name: "ผู้รักสุขภาพ",
          path: `/categories/ผู้รักสุขภาพ`,
        },
        {
          name: "ผู้ที่มีความต้องการเฉพาะอื่น ๆ",
          path: `/categories/ผู้ที่มีความต้องการเฉพาะอื่น ๆ`,
        },
      ]
    },
    {
